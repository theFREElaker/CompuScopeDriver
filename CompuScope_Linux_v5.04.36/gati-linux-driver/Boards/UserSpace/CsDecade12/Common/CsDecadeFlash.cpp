...
#define DECADE_FLASH_SECTOR_SIZE_BYTE	DECADE_FLASH_SECTOR_SIZE
//-----------------------------------------------------------------------------
//
//-----------------------------------------------------------------------------
int32	CsDecade::WriteBaseBoardFlash(uInt32 u32StartAddr, void *pBuffer, uInt32 u32Size, bool bBackup )
{	
	...
	uInt32	u32SectorSize = DECADE_FLASH_SECTOR_SIZE_BYTE;
