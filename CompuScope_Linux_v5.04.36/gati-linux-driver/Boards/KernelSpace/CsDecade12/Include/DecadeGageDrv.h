#ifndef decadegagedrv_h
#define decadegagedrv_h
...
} DECADE_INTERRUPT_CONTEXT, *PDECADE_INTERRUPT_CONTEXT;

WDF_DECLARE_CONTEXT_TYPE_WITH_NAME (FDO_DATA, GageFdoGetData)
WDF_DECLARE_CONTEXT_TYPE_WITH_NAME (DECADE_INTERRUPT_CONTEXT, GetInterruptContext)
